...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--which_model_netF', type=str, default='resnet_9blocks', help='selects model to use for netF')
        parser.add_argument('--which_model_netP', type=str, default='resnet_9blocks', help='selects model to use for netP')
        ...
        parser.add_argument('--pretrained_model_dir', type=str, default='./pretrained_models', help='pretrained models are saved here')
        ...
        parser.add_argument('--use_ce_loss', action='store_true', help='use cross entropy loss in regression.')
